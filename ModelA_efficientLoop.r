...
summaryRes_A_effL <- extract_results(results_A_effL,paramNames)

performance_A_effL <- evaluate_performance(summaryRes_A_effL,true)

print(performance_A_effL)
...
plot_recovery(summaryRes_A_effL$postMean,true)
...
plot_coverage(performance_A_effL)
...
time_taken_A_effL <- end_time - start_time

# Print the result (default unit is seconds)
print(time_taken_A_effL) #Time difference of 46.2275 mins for 1000 burnin, 2000 iteration, 3 sim